...
dataset_reference_classifiers = {
    ...
    'CIFAR10':                [ModelFactory(CLS.Scaled_VGG, scale=(3,32,32), classes=10, epochs=60), ModelFactory(CLS.Scaled_Resnet, scale=(3,32,32), classes=10, epochs=60)],
    'CIFAR100':               [ModelFactory(CLS.Scaled_VGG, scale=(3,32,32), classes=100, epochs=60), ModelFactory(CLS.Scaled_Resnet, scale=(3,32,32), classes=100, epochs=60)],
    'STL10':                  [ModelFactory(CLS.Scaled_VGG, scale=(3, 96, 96), classes=10, epochs=60), ModelFactory(CLS.Scaled_Resnet, scale=(3, 96, 96), classes=10, epochs=60)],
    'TinyImagenet':           [ModelFactory(CLS.Scaled_VGG, scale=(3, 64, 64), classes=200, epochs=60), ModelFactory(CLS.Scaled_Resnet, scale=(3, 64, 64), classes=200, epochs=60)],
}
