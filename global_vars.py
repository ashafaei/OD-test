...
dataset_reference_classifiers = {
    'MNIST':                  [ModelFactory(CLS.Scaled_VGG_2GPU, scale=(1,28,28), classes=10, epochs=60), ModelFactory(CLS.Scaled_Resnet, scale=(1,28,28), classes=10, epochs=60)],
    'FashionMNIST':           [ModelFactory(CLS.Scaled_VGG_2GPU, scale=(1,28,28), classes=10, epochs=60), ModelFactory(CLS.Scaled_Resnet, scale=(1,28,28), classes=10, epochs=60)],
    'CIFAR10':                [ModelFactory(CLS.Scaled_VGG_2GPU, scale=(3,32,32), classes=10, epochs=60), ModelFactory(CLS.Scaled_Resnet, scale=(3,32,32), classes=10, epochs=120)],
